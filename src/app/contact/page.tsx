...
export const metadata = createMetadata({
  title: 'Contact',
  description:
    'Contattami per progetti software, prodotti digitali, sistemi custom e richieste press.',
  path: '/contact',
});
      ...
      <section className='editorial-shell grid gap-10 py-12 md:grid-cols-12 md:py-20'>
        <div className='md:col-span-5'>
          ...
          <h2 className='text-5xl font-black uppercase leading-none'>
            Mail first. Meeting later.
          </h2>
          <p className='mt-5 text-pretty text-muted'>
            Scrivimi una mail chiara: contesto, obiettivo, vincoli, tempi. Se ha
            senso, poi si parla.
          </p>
          <div className='mt-7'>
            <Button href={site.contactEmailHref}>
        ...
        <div className='md:col-span-7'>
          ...
          <form
            ...
            <p className='text-sm text-muted'>
              Il form usa il client email locale. Nessun dato viene salvato dal
              sito web.
            </p>
          </form>
        </div>
